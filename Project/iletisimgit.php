...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top shadow-lg">
        <a class="navbar-brand" href="index.html">Aziz Şimşek</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="hakkimda.html">Hakkımda ve İlgi Alanlarım <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Egitim.html">Egitim Bilgilerim</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="ulas.html">Sosyal Medya ve Github</a>
            </li>
        ...
        <div class="bg-dark container border border-secondary rounded shadow-lg">
          ...
          <div class="row my-1 ">
            ...
            <table   class="table table-striped table-dark my-table" align="center">
              ...
              <tr>
                <td>Lütfen Email'inizi Giriniz:</td>
                <td ><?php echo $_POST["email"]?></td>
            	</tr>
              <tr>
                <td>Lütfen Şifrenizi Giriniz:</td>
                <td ><?php echo $_POST["sifre"]?></td>
              </tr>
              <tr>
                <td>İlgi Alanların</td>
                <td >
              ...
              <tr>
                <td>Yazılımcı Olarak Hangisisin ?</td>
              ...
              <tr>
                <td>Lütfen yaşadınız şehiri seçiniz</td>
